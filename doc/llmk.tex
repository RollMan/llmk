...
\date{v1.2.1+rollman.1+doc\quad\today}
...
\begin{clopt}{\sopt{i}, \lopt{source}}
Substitute the given argument value for the \code{source} entry on
\code{llmk.toml} or magic comments at runtime. This would be useful if you
use, for example, \code{subfiles} and want to specify a path to a source
file to be built.
\end{clopt}
